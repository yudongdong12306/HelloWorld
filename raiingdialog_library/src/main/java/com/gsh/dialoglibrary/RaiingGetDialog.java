...
public class RaiingGetDialog {
     ...
     */
    public RaiingGetDialog(Activity activity, String title, String message, String positiveButton, String negativeButton, CallbackRaiingAlertDialog allbackRaiingAlertDialog) {
        if (activity == null) {
    ...
    public interface CallbackRaiingAlertDialog {
         ...
         * 点击确定
         */
        void onPositive(boolean isChecked);
    ...
    private class MyAlertDialog extends AlertDialog implements View.OnClickListener {
        ...
        private CheckBox not_remind_cb;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.dialog_alert_get);
            initLayout();
            initData();
        }
        ...
        private void initLayout() {
            ...
            not_remind_cb = (CheckBox) findViewById(R.id.not_remind_cb);
...
//            setCancelable(false);
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.dialog_alert_cancle1) {
                ...
                if (mCallbackRaiingAlertDialog != null) {
                    mCallbackRaiingAlertDialog.onPositive(not_remind_cb.isChecked());
                }
