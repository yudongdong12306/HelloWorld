...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public TimePickerView(Context context, Type type) {
        ...
        // -----确定和取消按钮
        btnSubmit = findViewById(R.id.topbar_confirm_btn);
        btnSubmit.setTag(TAG_SUBMIT);
        btnCancel = findViewById(R.id.topbar_cancel_btn);
        ...
        switchbtn = ((SwitchButton) findViewById(R.id.topbar_switch_btn));
     ...
     * @param context   上下文
     * @param type      滚轮类型
     * @param startYear 年滚轮中开始的值
     * @param endYear   年滚轮中结束的值
     */
    public TimePickerView(Context context, Type type, int startYear, int endYear) {
        ...
        // ----时间转轮
        final View timepickerview = findViewById(R.id.timepicker);
        wheelTime = new WheelTime(timepickerview, type, startYear, endYear);
...
//    }
    ...
    public void setCyclic(boolean cyclic, boolean yearCycle) {
        wheelTime.setCyclic(cyclic, yearCycle);
    }
