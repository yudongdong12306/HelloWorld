...
import com.bigkoo.pickerview.dialog.PickerBaseDialog;
...
//        decorView.addView(view);
    ...
    private void alertDialog(View view) {
        mDialog = new PickerBaseDialog(context, R.style.Dialog_Fullscreen);
...
//        onAttached(rootView);
    ...
    public void setCancelBack(boolean isCancel){
