...
public class SwitchButton extends RelativeLayout implements View.OnClickListener {
    ...
    public SwitchButton(Context context, AttributeSet attrs) {
        ...
        mSelectTextColorBg = ta.getColor(R.styleable.switch_button_select_text_color_bg, getResources().getColor(R.color.picker_ba));
        mUnSelectTextColor = ta.getColor(R.styleable.switch_button_unselect_text_color, getResources().getColor(R.color.picker_ba));
        mUnSelectTextColorBg = ta.getColor(R.styleable.switch_button_unselect_text_color_bg, getResources().getColor(R.color.pickerview_white));
    ...
    private void setClickSelectColor(int index) {
        switch (index) {
            case 0:
                ...
                mLeftText.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.shape_left_tv_un));
//                mLeftText.setBackground(getResources().getDrawable(R.drawable.shape_left_tv));
                mRightText.setTextColor(mSelectTextColor);
                mRightText.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.shape_right_tv));
//                mRightText.setBackground(getResources().getDrawable(R.drawable.shape_right_tv_un));
                break;
            case 1:
                mLeftText.setTextColor(mSelectTextColor);
                mLeftText.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.shape_left_tv));
//                mLeftText.setBackground(getResources().getDrawable(R.drawable.shape_left_tv_un));
                mRightText.setTextColor(mUnSelectTextColor);
                mRightText.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.shape_right_tv_un));
